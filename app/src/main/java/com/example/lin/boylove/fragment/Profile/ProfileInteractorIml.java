...
public class ProfileInteractorIml implements ProfileInteractor {
    private Context context;
    private DolaxAPIs dolaxAPIs;

    public ProfileInteractorIml(Context context) {
        this.context = context;
        dolaxAPIs = DolaxAPIs.Factory.create();
    }

    @Override
    public void getListOnline(final ProfilePresenter.OnOnlineFinishedListener listener) {
